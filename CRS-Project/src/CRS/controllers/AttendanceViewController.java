...
public class AttendanceViewController implements Initializable {
    ...
    public class Object{
        ...
        public Object(String course, String sec, String absent){
            this.absent = absent;
            this.course = course;
            this.section = sec;
        }
    ...
    @FXML TableColumn<Object,String> absent;
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        ArrayList<Registration> regs = obj.see_attendance();
        for (int i = 0; i < regs.size(); i++) {
            objects.add(new Object(regs.get(i).get_course(), regs.get(i).get_section(),
                    String.valueOf(regs.get(i).get_attendance())));
        }
...
//                System.out.println("Attd : " + objects.get(rows).getAbsent());
//                System.out.println("Crs : " + objects.get(rows).getCourse());
//                System.out.println("Sec : " + objects.get(rows).getSection());
//                rows++;
//            }
//        } catch (Exception e) {
//            System.out.println("Couldn't load Attendance");
//        }
        ...
        absent.setCellValueFactory(new PropertyValueFactory<Object,String>("absent"));
